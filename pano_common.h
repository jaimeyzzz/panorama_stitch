#ifndef PANORAMASTITCH_PANOCOMMON_H_
#define PANORAMASTITCH_PANOCOMMON_H_
...
struct PanoParam {                  // 记录生成全景图的参数。
    int w, h;                       // 生成全景图的宽度，高度
    double hfov;                    // 生成全景图的视野范围，1~360°
};

struct ImageParam {                 // 记录每路视频帧的参数
    int w, h, f;                    // 帧宽度，高度，类型
...
#endif // PANORAMASTITCH_PANOCOMMON_H_