...
PanoScript::PanoScript(std::string script_name) {
...
void PanoScript::LoadScript(const std::string& script_name) {
...
void PanoScript::ReadPanoLine(const std::string& line) {
...
ImageParam PanoScript::ReadImageLine(const std::string& line) {  
    std::istringstream istr(line);
    std::string str;
